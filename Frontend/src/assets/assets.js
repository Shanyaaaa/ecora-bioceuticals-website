...
export const products = [
  {
    ...
    description:
      'Advanced calcium supplement with Vitamin D3 & K2-MK7. Promotes strong bones, healthy teeth, and joint support for growing and geriatric pets. Supports healing in fractures, rickets, osteoporosis, and osteomalacia.',
    price: 450,
    image: [calcinexTab1],
    category: 'Pets',
  ...
  },
  {
    ...
    description:
      'Synergistic blend of Sylimarin, Tricholine Citrate, N-Acetylcysteine, Selenium Dioxide, Artichoke & Catechins. Supports liver detoxification, improves digestion, and helps manage liver-related conditions.',
    price: 290,
    image: [artimarinHome],
    category: 'Pets',
...
// ✅ Export all assets in one object
export const assets = {
  aminopetFront,
  artimarinHome,
  calcinexHome,
